...
example : ¬ Symmetric ((· : Set ℕ) ⊆ ·) := by
  ...
  use {1}, {1,2}
  constructor
  · intro x; dsimp; exhaust
  · intro h
    have: 2 ∈ {1,2}:= by dsimp; exhaust
    apply h at this
    dsimp at this; exhaust
...
example : AntiSymmetric (· ≺ ·) := by
  ...
  dsimp at h1 h2
  constructor
  · apply le_antisymm h1.1 h2.1
  · apply le_antisymm h1.2 h2.2
